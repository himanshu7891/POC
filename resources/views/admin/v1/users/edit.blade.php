                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control {{ $errors->has('team_id') ? 'is-invalid' : '' }}" name="team_id" id="team_id" required>
                            ...
                            @foreach($teams as $key => $row)
                                <option value="{{ $row->id }}" {{ (old('team_id') == $row->id) || $user->userTeamBranch->team_id == $row->id  ? 'selected' : '' }}>{{ $row->team_code }} ({{ $row->name }})</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control {{ $errors->has('branch_id') ? 'is-invalid' : '' }}" name="branch_id" id="branch_id" required>
                            ...
                            @foreach($branches as $key => $row)
                                <option value="{{ $row->id }}" {{ (old('branch_id') == $row->id) || $user->userTeamBranch->branch_id == $row->id  ? 'selected' : '' }}>{{ $row->branch_code }} ({{ $row->name }})</option>
                            @endforeach
                        </select>
